module github.com/twinfer/twincore
...
require (
	...
	github.com/greenpau/caddy-security v1.1.31 // indirect
	...
	golang.org/x/crypto/x509roots/fallback v0.0.0-20250515174705-ebc8e4631531 // indirect
