...
import (
	// "time" // For now, using string for timestamps as per JSON representation
)
...
type PropertyAffordance struct {
	...
	DataSchema // Embed DataSchema fields directly (type, readOnly, writeOnly, observable, etc.)
}
...
func (pa *PropertyAffordance) IsReadOnly() bool { return pa.DataSchema.ReadOnly }
// IsWriteOnly returns the writeOnly status from the embedded DataSchema.
func (pa *PropertyAffordance) IsWriteOnly() bool { return pa.DataSchema.WriteOnly }
// IsObservable returns the observable status from the embedded DataSchema.
func (pa *PropertyAffordance) IsObservable() bool { return pa.DataSchema.Observable }
...
func (aa *ActionAffordance) GetInput() wot.DataSchema { return aa.Input } // wot.DataSchema is interface
// GetOutput returns the output schema for the action.
func (aa *ActionAffordance) GetOutput() wot.DataSchema { return aa.Output } // wot.DataSchema is interface
...
func (ea *EventAffordance) GetData() wot.DataSchema { return ea.Data } // wot.DataSchema is interface
